...
(function () {
  ...
  function Ab(a) {
    L &&
      !1 !== D["zoom-in"] &&
      ((a = a.deltaY), 0 > 0.5 * (0 > a ? 1 : a ? -1 : 0) ? cb() : bb());
  }
  function W(a, b) {
    ("boolean" === typeof a ? a : !R) === !R &&
      ((R = R ? clearTimeout(R) : 1), d(Ua, "on", R), b || sb(R));
  }
  function sb(a) {
    ua &&
      (ba(O, function () {
  ...
  function cb() {
    ...
    x && V();
    1 <= a &&
      (1 === a ? (r = t = 0) : ((r *= 0.65), (t *= 0.65)), Z(r, t), Eb(a));
  }
  function Eb(a) {
    v = a || 1;
    qb();
  ...
  function Gb(a) {
    ...
    Ba &&
      ...
      (b = C[z]) &&
      ((a = b.dataset || b),
      ((A = a.media) && "image" !== A) || (Q = ia(b, c, a, A)));
  ...
  function nb(a) {
    ...
    var c = Y("description"),
      ...
      f = a || c || e;
    f &&
      (a && (Na.firstChild.nodeValue = a),
      c && (Oa.firstChild.nodeValue = c),
      e && (Pa.firstChild.nodeValue = e),
      l(Na, a),
      l(Oa, c),
      l(Pa, e),
      g(Ma, "transform", "all" === za ? "" : "none"));
    za || d(p, "menu", !0);
    da(Ma, f);
    da(Qa, G || 1 < z);
    da(Ra, G || z < B);
